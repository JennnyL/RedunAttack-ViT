...
HYPER_PARAM_TYPE=pit  NUM_ROBUST_TOKENS=100 ROBUST_TOKENS_TYPE=dynamic python main.py --input_dir /home/cxu-serve/p62/zzh136/global_prune/attack/data/TransferAttack/data  --output_dir adv_data --attack ll2s --model pit_b_224 --batchsize 8
echo "pit dynamic 100 best param"  >> debug_pit_log.txt
python main.py --input_dir /home/cxu-serve/p62/zzh136/global_prune/attack/data/TransferAttack/data  --output_dir adv_data --attack ll2s --model pit_b_224  --eval  >> debug_pit_log.txt
echo "" >> debug_pit_log.txt
echo "" >> debug_pit_log.txt
